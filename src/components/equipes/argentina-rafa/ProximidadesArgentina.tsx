...
const ARGENTINA_ADDRESSES: (NearbyAddress & { periodo: string })[] = [
  // ── Kansas City MO ────────────────────────────────────────────
  {
    id: "ar-kc-hotel",
  ...
  {
    id: "ar-dal-hotel",
    name: "Residence Inn by Marriott Dallas Downtown",
...
export function ProximidadesArgentina() {
  return (
    <main className="mx-auto w-full max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Equipe Argentina · Rafa Morientes e Djalminha · 2 cidades.
        </p>
      </div>

      <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
        {ARGENTINA_ADDRESSES.map((addr) => (
