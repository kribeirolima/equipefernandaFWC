...
export function LocacoesBeltChico() {
    ...
    <main className="mx-auto w-full max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          nas cidades do roteiro da Equipe Brasil · Belt e Chico. Filtre por cidade, categoria, período do dia e permit.
        </p>
      </div>
      ...
      <div className="space-y-2 rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm dark:border-amber-500/30 dark:bg-amber-500/10">
        ...
        <ul className="ml-4 list-disc space-y-1 text-xs text-amber-900/90 dark:text-amber-200/90">
          <li>
            <strong>New Jersey — espaços públicos:</strong> Morris County Office of Tourism and Film para Morristown Green e Lewis Morris County Park. Contato via morriscountynj.gov.
          </li>
          <li>
            <strong>Cleveland:</strong> Greater Cleveland Film Commission (clevelandfilm.com) para Edgewater Park e espaços públicos do condado.
          </li>
          <li>
            <strong>Philadelphia:</strong> Philadelphia Film Office (film.org) para Love Park e JFK Plaza. Gratuito para espaços públicos — prazo recomendado de 5–10 dias úteis.
          </li>
          <li>
            <strong>Miami:</strong> Miami-Dade Film Office (filmiami.org) para Margaret Pace Park e espaços públicos do município. Miami Beach Film &amp; Print Office para locações em Miami Beach (The Broken Shaker).
          </li>
          <li>
            <strong>Privado (qualquer cidade):</strong> Negociar diretamente — Assembly Rooftop (Logan Hotel), Platform Beer Co., Jockey Hollow e The Broken Shaker têm tarifas específicas para uso comercial.
          </li>
        </ul>
      </div>
    </main>
