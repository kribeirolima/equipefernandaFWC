...
const KLAYN_LEO_ADDRESSES: (NearbyAddress & { periodo: string })[] = [
  {
    id: "kl-morristown-hotel",
...
export function ProximidadesKlaynLeo() {
  return (
