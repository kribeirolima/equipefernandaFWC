...
const URUGUAI_ADDRESSES: (NearbyAddress & { periodo: string })[] = [
  // ── Cancún ───────────────────────────────────────────────────
  {
    id: "cun-hotel",
    name: "Fairfield Inn & Suites Cancún Downtown",
    address: "Av. Tulum 220, 77500 Cancún, Q.R.",
    city: "Cancún",
    country: "México",
    lat: 21.1619,
    lng: -86.8515,
  ...
  {
    id: "mia-1-hotel",
    name: "Airbnb Miami 1ª (ref. Brickell)",
    address: "Brickell, Miami, FL — endereço a confirmar",
    city: "Miami",
    country: "Estados Unidos",
    lat: 25.7617,
    lng: -80.1918,
    locale: "en",
    note: "Airbnb pendente — buscas a partir de Brickell como referência",
    periodo: "13–16 jun",
  },
  {
    id: "mia-1-stadium",
  ...
  {
    id: "bos-hotel",
    name: "The Midtown Hotel MOD by Sonesta",
  ...
  {
    id: "mia-2-hotel",
    name: "Airbnb Miami 2ª (ref. Brickell)",
    address: "Brickell, Miami, FL — endereço a confirmar",
    city: "Miami",
    country: "Estados Unidos",
    lat: 25.7617,
...
export function ProximidadesUruguai() {
  return (
